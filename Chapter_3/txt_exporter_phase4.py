...
def export_point_cloud_to_txt(whole_node_path, extracted_node_path, param_node_path, work_item):
    ...
    def update_sop_parameters(node_path):
        ...
        for attrib_name in ['B3_posy', 'A2_posy', 'A1_posy', 'B4_HIJIKI_num', 'B3_HIJIKI_num', 'A2_HIJIKI_num', 'A1_HIJIKI_num', 'class_extract']:
    ...
    common_path = f'{B3_posy}_{A2_posy}_{A1_posy}pos__{A1_HIJIKI_num}_{A2_HIJIKI_num}_{B4_HIJIKI_num}_{B3_HIJIKI_num}num'
    whole_file_path = f'{base_path}{common_path}/{common_path}.txt'
    extracted_file_path = f'{base_path}{common_path}/Annotations/{class_extract}_1.txt'
